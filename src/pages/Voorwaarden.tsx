    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Algemene Voorwaarden</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-8">Laatst bijgewerkt: 10 december 2025</p>

            <div className="prose prose-gray dark:prose-invert max-w-none">
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 1 – Definities</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 2 – Toepasselijkheid</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 3 – Offertes en overeenkomsten</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 4 – Prijzen en betaling</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 5 – Uitvoering van de opdracht</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 6 – Abonnement en opzegging</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 7 – Wijzigingen en meerwerk</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 8 – Intellectueel eigendom</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 9 – Hosting en beschikbaarheid</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 10 – Aansprakelijkheid</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 11 – Niet-goed-geld-terug garantie</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Artikel 14 – Toepasselijk recht en geschillen</h2>
                <ol className="text-gray-600 dark:text-gray-300 space-y-2 list-decimal list-inside">
