    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Privacybeleid</h1>
            <p className="text-gray-500 mb-8">Laatst bijgewerkt: 10 december 2025</p>

            <div className="prose prose-gray dark:prose-invert max-w-none">
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">1. Wie zijn wij?</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">2. Welke gegevens verzamelen wij?</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">3. Waarvoor gebruiken wij deze gegevens?</h2>
                <ul className="text-gray-600 dark:text-gray-300 space-y-2 list-disc list-inside">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">4. Delen van gegevens</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">5. Bewaartermijnen</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">6. Jouw rechten</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">8. Beveiliging</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">9. Klachten</h2>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">10. Wijzigingen</h2>
                <p className="text-gray-600 dark:text-gray-400">
