  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="relative max-w-4xl mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border-2 border-gray-200 dark:border-slate-700 overflow-hidden">
            {/* Gradient accent line */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-500 via-blue-500 to-primary-500" />
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <div className="flex items-start gap-4 w-full sm:w-auto">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="sm:hidden p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-xl transition-colors flex-shrink-0 ml-auto border-2 border-transparent hover:border-gray-200 dark:hover:border-slate-600"
                ...
                <div className="flex-1 w-full">
                  ...
                  <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 mt-4">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 transition-all shadow-lg shadow-blue-500/30 text-sm"
                    >
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-slate-700 transition-all text-sm border-2 border-gray-200 dark:border-slate-600"
                    >
