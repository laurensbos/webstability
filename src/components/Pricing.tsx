			...
			<div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="lg:hidden relative">
					...
					<button
						...
						className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center border border-gray-200 transition-opacity ${
					...
					<button
						...
						className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center border border-gray-200 transition-opacity ${
					...
					{/* Swipe hint */}
					<div className="absolute -top-6 right-4 text-xs text-gray-400 flex items-center gap-1">
						<span>Swipe</span>
				...
				<div className="hidden lg:grid lg:grid-cols-4 gap-6 mb-16">
					{packages.map((pkg, index) => (
						<motion.div
							...
							viewport={{ once: true }}
							transition={{ delay: index * 0.1 }}
							className={`relative rounded-2xl p-6 flex flex-col bg-white transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
								pkg.popular
									? 'border-2 border-primary-500 shadow-lg shadow-primary-100'
				...
				>
					<p className="text-gray-500 text-sm flex flex-wrap justify-center gap-x-6 gap-y-2">
					...
					<p className="text-sm text-gray-500">
						...
						<span className="text-primary-600 font-medium"> Als ondernemer krijg je de BTW terug via je belastingaangifte</span>
					</p>
				</motion.div>
			</div>
		</section>
